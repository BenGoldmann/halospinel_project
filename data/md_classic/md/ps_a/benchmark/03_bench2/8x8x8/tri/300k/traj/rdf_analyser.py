...
# Data import:
pipeline = import_file('monoclinic_8x8x8_300.lammpstrj', multiple_frames = True)
...
export_file(pipeline, 'rdf_data_sccl.txt', 'txt/table', key='coordination-rdf[average]', multiple_frames=False)
